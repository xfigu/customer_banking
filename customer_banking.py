...
def main():
    ...
    savings_interest = float(input("Enter the annual interest rate (as a percentage) for the savings account: ")) / 100
    savings_maturity = int(input("Enter the number of months the savings account will mature: "))
    ...
    cd_interest = float(input("Enter the annual interest rate (as a percentage) for the CD account: ")) / 100
    cd_maturity = int(input("Enter the number of months the CD account will mature: "))
